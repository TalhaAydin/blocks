...
export const createIPiece = () =>
  createEntityData(
    {
      [getHash(createPoint(-1, 0))]: { color: 'aqua' },
      [getHash(createPoint(0, 0))]: { color: 'aqua' },
      [getHash(createPoint(1, 0))]: { color: 'aqua' },
      [getHash(createPoint(2, 0))]: { color: 'aqua' },
    },
    createVector(4, 0),
    0
  )
  ...
  createEntityData(
    {
      ...
      [getHash(createPoint(1, 0))]: { color: 'blue' },
      [getHash(createPoint(1, -1))]: { color: 'blue' },
    },
    createVector(5, 1),
    0
  ...
  createEntityData(
    {
      ...
      [getHash(createPoint(-1, 0))]: { color: 'orange' },
      [getHash(createPoint(-1, -1))]: { color: 'orange' },
    },
    createVector(5, 1),
    0
